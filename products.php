    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/audi-logo.png" width="90px" alt=""></a>
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-danger btn-lg disabled">Order</a>

                                <?php
                                        }
                                        else{   
                                        ?>
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-success btn-lg active">Order</a>
                                <?php   
                                        }
                                        ?>
                ...
                <div class="food-item">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                            ...
                            <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Add To Card" />
                            ...
                            <form action="" method="post">
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <p> <input type="submit" value="Add a Comment" name="submit" class="btn theme-btn"> </p>
...
if(isset($_POST['submit'] )) 
{
     if(empty($_POST['comment']))
		...
		{
            echo "<script>alert('Add a Comment please!');</script>";
		}else{
